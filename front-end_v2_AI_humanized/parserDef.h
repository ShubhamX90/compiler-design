/*
 * parserDef.h
 * data structures for the LL(1) parser
 * CS F363 - BITS Pilani
 *
 * Non-terminals updated for Modified LL(1) Grammar (Feb 13, 2026):
 *   NT_ACTUALORREDEFINED, NT_FIELDTYPE,
 *   NT_OPTION_SINGLE_CONSTRUCTED, NT_ONEEXPANSION, NT_MOREEXPANSIONS,
 *   NT_ELSEPART,
 *   NT_EXPPRIME, NT_TERMPRIME, NT_FACTOR, NT_HIGHPRECEDENCEOP,
 * NT_LOWPRECEDENCEOP
 */
